...
#test
python -u test_hoi.py hoidet --exp_id hoidet_hico_dla_3levelglob --arch dla3levelglob_34 --resume  --gpus 3 --image_dir images/test2015 --dataset hico --test_with_eval
